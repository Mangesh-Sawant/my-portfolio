    ...
    return (
        <div className="relative inline-block w-[55px] h-[30px] border-2 border-gray-200 rounded-3xl">
            ...
            <label htmlFor="darkmode-toggle"
                ...
                <IconMoon size={16} className="text-accent-primary"/>
                <IconSun size={16} className="text-accent-secondary"/>
                <span className={`absolute w-[22px] h-[22px] left-[2px] bottom-[2px] bg-primary rounded-full transition-all duration-300 ease-in-out
